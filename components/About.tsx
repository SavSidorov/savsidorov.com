  ...
  return(
    <div className={styles.about}>
      ...
      <div className={styles.content}>
        ...
        <p>I’m a recent electrical engineering graduate interested in <Link href="https://www.youtube.com/watch?v=agOdP2Bmieg"><span>humane software</span></Link>, neurotech, robotics and the <Link href="https://savsidorov.substack.com/p/the-future-of-learning"><span>future of learning</span></Link>.</p>
