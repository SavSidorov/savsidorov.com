	...
	return (
        ...
        `}
			>
				...
				<div>
					<Image
						src="/images/frc2016/5897_team.jpg"
						alt="Team Photo"
						width={screenWidth > 700 ? 640 / 1.2 : 640 / 2.2}
						height={screenWidth > 700 ? 480 / 1.2 : 480 / 2.2}
					/>
				</div>

				<div>
					<Image
						src="/images/frc2016/impulse.png"
						alt="Impulse"
						width={screenWidth > 700 ? 750 / 1.4 : 750 / 2.6}
						height={screenWidth > 700 ? 540 / 1.4 : 540 / 2.6}
					/>
				</div>
				...
				<div>
					<iframe
						...
						src="https://www.youtube.com/embed/iiEHdTanE8U"
