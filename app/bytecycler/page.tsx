	...
	return (
        ...
        `}
			>
				...
				<div>
					<Image
						src="/images/bytecycler/johann-sav.jpg"
						alt="Johann & Sav"
						width={screenWidth > 700 ? 1686 / 3 : 1686 / 5.8}
						height={screenWidth > 700 ? 1125 / 3 : 1125 / 5.8}
					/>
				</div>
				...
				<div>
					<Image
						src="/images/bytecycler/graph-interface.png"
						alt="Topic Graph"
						width={screenWidth > 700 ? 1905 / 3 : 1905 / 6.5}
						height={screenWidth > 700 ? 972 / 3 : 972 / 6.5}
					/>
				</div>
				...
				<div>
					<Image
						src="/images/bytecycler/echo-formula.png"
						alt="Echo Score"
						width={screenWidth > 700 ? 1628 / 7 : 1628 / 7.5}
						height={screenWidth > 700 ? 352 / 7 : 352 / 7.5}
					/>
				</div>
				...
				<div>
					<Image
						src="/images/bytecycler/nodes.png"
						alt="Nodes"
						width={screenWidth > 700 ? 192 / 1.7 : 192 / 2}
						height={screenWidth > 700 ? 211 / 1.7 : 211 / 2}
					/>
				</div>
				<div>
					<p>
				...
				<div>
					<Image
						src="/images/bytecycler/node-hover.png"
						alt="Nodes on hover"
						width={screenWidth > 700 ? 191 / 1.7 : 191 / 2}
						height={screenWidth > 700 ? 212 / 1.7 : 212 / 2}
					/>
				</div>
				...
				<div>
					<Image
						src="/images/bytecycler/sources.png"
						alt="Sources"
						width={screenWidth > 700 ? 1904 / 3 : 1904 / 6.5}
						height={screenWidth > 700 ? 970 / 3 : 970 / 6.5}
					/>
				</div>
				<div>
					<Image
						src="/images/bytecycler/source.png"
						alt="Source"
						width={screenWidth > 700 ? 1920 / 3 : 1920 / 6.5}
						height={screenWidth > 700 ? 974 / 3 : 974 / 6.5}
					/>
				</div>
			</div>
		</Fade>
