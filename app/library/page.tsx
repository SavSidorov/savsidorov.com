          ...
          <div className={styles.essays}>
            {
              screenWidth > 700 ?
                sortByAuthor(essays).map((essay, index) => (
                  <p key={index}>{essay.author} – <Link href={essay.url}><span>{essay.title}</span></Link></p>  
                ))
              :
                sortByTitle(essays).map((essay, index) => (
                  <p key={index}><Link href={essay.url}><span>{essay.title}</span></Link></p>  
                ))
            }
          </div>
        </div>
          ...
          <div className={styles.papers}>
            {
              screenWidth > 700 ?
                sortByAuthor(papers).map((paper, index) => (
                    <p key={index}>{paper.author} – <Link href={paper.url}><span>{paper.title}</span></Link></p>
                ))
              :
                sortByTitle(papers).map((paper, index) => (
                  <p key={index}><Link href={paper.url}><span>{paper.title}</span></Link></p>
                ))
            }
          </div>
        </div>
        ...
        <div className={styles.interviewsSection}>
          ...
          <div className={styles.interviews}>
            {sortByTitle(interviews).map((interview, index) => (
              <p key={index}><Link href={interview.url}><span>{interview.title}</span></Link></p>
            ))}
          </div>
        </div>
          ...
          <div className={styles.stories}>
            {
              screenWidth > 700 ?
                sortByAuthor(shortStories).map((story, index) => (
                  <p key={index}>{story.author} – <Link href={story.url}><span>{story.title}</span></Link></p>
                ))
              :
                sortByTitle(shortStories).map((story, index) => (
                  <p key={index}><Link href={story.url}><span>{story.title}</span></Link></p>
                ))
            }
          </div>
        </div>
          ...
          <div className={styles.poetry}>
            {
              screenWidth > 700 ?
                sortByAuthor(poetry).map((poem, index) => (
                  <p key={index}>{poem.author} – <Link href={poem.url}><span>{poem.title}</span></Link></p>
                ))
              :
              sortByTitle(poetry).map((poem, index) => (
                <p key={index}><Link href={poem.url}><span>{poem.title}</span></Link></p>
              ))
            }
          </div>
        </div>
